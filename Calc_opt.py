    ...
    def fit(self, X="X", y="y", s="s", **kwargs):
        ...
        if self.criterion == "scaff":
            ...
            def evaluate_split(feature, value, indexs):
                ...
                if (lsize >= self.min_samples_leaf) and ((isize - lsize) >= self.min_samples_leaf):
                    ...
                    total_neg = isize - total_pos

                    tpr_y = pos_sum / total_pos
                    fpr_y = neg_sum / total_neg
                    ...
                    for s_column in range(self.s.shape[1]):
                        ...
                        if len(unique_s) >= 2:
                            for s in unique_s:
                                ...
                                total_neg = isize - total_pos
                                tpr_s = pos_sum / total_pos
                                fpr_s = neg_sum / total_neg
